...
//                serverSocket = bluetoothAdapter.getProfileProxy(this,,);
            } catch (IOException e) {
                e.printStackTrace();
                Log.e("error", "msg167-> " + e);
